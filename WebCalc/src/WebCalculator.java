/********************************************* 
Save this file as WebCalculator.java 
to compile it use 
    javac WebCalculator.java 
...
public class WebCalculator extends Frame  
{  
...
///////////////////////////  
WebCalculator(String frameText)//constructor  
{  
super(frameText);  
...
{  
new WebCalculator("Calculator - JavaTpoint");  
}  
}  
...
//////////////////////////////////////////  
MyDigitButton(int x,int y, int width,int height,String cap, WebCalculator clc)  
{  
super(cap);  
...
MyOperatorButton(int x,int y, int width,int height,String cap, WebCalculator clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
if(opText.equals("1/x"))  
    ...
    try  
        ...
        cl.displayLabel.setText(WebCalculator.getFormattedText(tempd));}  
...
cl.displayLabel.setText(WebCalculator.getFormattedText(temp));  
//cl.number=temp;  
}//actionPerformed  
}//class  
...
/////////////////////////////////  
MyMemoryButton(int x,int y, int width,int height,String cap, WebCalculator clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
case 'R':   
    cl.displayLabel.setText(WebCalculator.getFormattedText(cl.memValue));break;  
case 'S':  
    cl.memValue=0.0;  
case '+':   
...
MySpecialButton(int x,int y, int width,int height,String cap, WebCalculator clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
